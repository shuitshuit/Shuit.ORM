...
namespace ShuitNet.ORM.MySQL
{
    public class MySQLConnect : IDisposable
    {
        ...
        /// </summary>
        /// <param name="connectionString">Connection string format: Server=xxx;Port=xxx;Database=xxx;Uid=xxx;Pwd=xxx</param>
        ...
        /// <summary>
        /// connection string format: Server=xxx;Port=xxx;Database=xxx;Uid=xxx;Pwd=xxx
        /// </summary>
        /// <returns></returns>
        public sealed override string ToString() =>
            $"Server={Host};Port={Port};Database={Database};Uid={Username};Pwd={Password}";

        public static implicit operator string(MySQLConnect connection) => connection.ToString();
